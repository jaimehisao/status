# [📈 Live Status](https://uptime.hisao.org): <!--live status--> **🟥 Complete outage**

This repository contains the open-source uptime monitor and status page for [Hisao](jaimehisao.github.io).

[![Uptime CI](https://github.com/jaimehisao/status/workflows/Uptime%20CI/badge.svg)](https://github.com/jaimehisao/status/actions/workflows/uptime.yml)
[![Response Time CI](https://github.com/jaimehisao/status/workflows/Response%20Time%20CI/badge.svg)](https://github.com/jaimehisao/status/actions/workflows/response-time.yml)
[![Graphs CI](https://github.com/jaimehisao/status/workflows/Graphs%20CI/badge.svg)](https://github.com/jaimehisao/status/actions/workflows/graphs.yml)
[![Static Site CI](https://github.com/jaimehisao/status/workflows/Static%20Site%20CI/badge.svg)](https://github.com/jaimehisao/status/actions/workflows/site.yml)
[![Summary CI](https://github.com/jaimehisao/status/workflows/Summary%20CI/badge.svg)](https://github.com/jaimehisao/status/actions/workflows/summary.yml)
